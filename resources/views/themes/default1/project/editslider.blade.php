...
<body>
  ...
  <div class="st-container">
          ...
          <ul class="nav navbar-nav navbar-right">
           ...
           <li class="dropdown">
            ...
            <li class="dropdown user">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                <img src="{{asset('images/people/110/guy-6.jpg')}}" alt="" class="img-circle" /> {{Auth::user()->first_name}}<span class="caret"></span>
              </a>
              <ul class="dropdown-menu" role="menu">
                <li><a href="{{url('profile')}}"><i class="fa fa-user"></i>Profile</a></li>
                <li><a href="{{url('setting')}}"><i class="fa fa-wrench"></i>Settings</a></li>
    ...
    <aside class="sidebar left sidebar-size-3 sidebar-offset-1 sidebar-skin-white sidebar-visible-desktop">
      ...
      {!! Form::model($slider,['url'=>'sliders/'.$slider->slug,'method'=>'patch','enctype'=>'multipart/form-data', 'files'=>true]) !!}
        <div class="sidebar-block equal-padding">
         <div class="form-group form-control-default {{ $errors->has('title') ? 'has-error' : '' }}">
              <label for="title">Title</label>
              {!! $errors->first('title', '<spam class="help-block">:message</spam>') !!}
              <input type="text" placeholder="Listing Title" name="title" class="form-control" id="title" value="{{$slider->title}}">
            </div>
        </div>
        ...
        <div class="sidebar-block equal-padding">
          <div class="form-group form-control-default {{ $errors->has('description') ? 'has-error' : '' }}">
              ...
              <textarea id="description" class="form-control" rows="6" cols="30"  style=" max-width: 102%" name="description" >{{$slider->description}}</textarea>
            </div>
        </div>
    ...
    <div class="sidebar-block equal-padding">
      <div class="form-group form-control-default {{ $errors->has('gallery') ? 'has-error' : '' }}">
              ...
              <input type="file" class="form-control"  name="gallery" /><br>
              <img src="{{asset('images/project/gallery/'.$slider->gallery)}}" class="img-thumbnail" style="height: 100px;">
            </div>
      </div>
    ...
    <div class="sidebar-block equal-padding">
        ...
        <div class="form-group form-control-default {{ $errors->has('expiry') ? 'has-error' : '' }}">
            ...
            <div class="input-group">
              ...
              <input id="check-out" class="datepicker form-control" type="text" name="expiry" value="{{$slider->expiry}}">
            </div>
          </div>
    </div>
