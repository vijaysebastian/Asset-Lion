  ...
  <div class="st-container">
    ...
    <aside class="sidebar left sidebar-size-3 sidebar-offset-1 sidebar-skin-white sidebar-visible-desktop" id=sidebar-filter>
      <div data-scrollable>
        ...
        {!! Form::open(['url'=>'property','method'=>'get']) !!}

          <div class="form-group input-group">
            <input type="text" class="form-control" placeholder="Search" name="property_search">
        ...
        <div class="st-content-inner padding-top-none" id="content">
         ...
         @if(Session::has('success'))
          ...
          <div class="container-fluid">
              ...
              <div class="panel-body">
                <div class="media media-clearfix-xs media-clearfix-sm">
                  <div class="media-left">
                    <p>
                      <a href="{{url('property/'.$prop->slug)}}">
                      <?php $gallery = App\Model\Gallery::where('property_list_id',$prop->id)->first();  ?>
                      @if($gallery)
                        <img src="images/gallery/{{$gallery->name}}" alt="property" width="150" class="media-object" />
                      @else
                  ...
                  <div class="media-body">
                    ...
                    @if(Auth::user()->authority == 'admin')
                     ...
                     @if($prop->approve=='0')
                      ...
                      <a href="{{url('property/approve/'.$prop->slug)}}" class="btn btn-info"> Approve </a>

                     @else

                      <a href="{{url('property/disapprove/'.$prop->slug)}}" class="btn btn-info"> Disapprove </a>
                    ...
                    <div class="label">
                      ...
                      <a href="{{route('property.edit',$prop->slug)}}" class="btn btn-primary"> Edit </a>
            ...
            @empty
            <p>Sorry Their is no Such Property </p>
