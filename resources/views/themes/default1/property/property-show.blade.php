      ...
      <div class="st-content">
        ...
        <div class="st-content-inner padding-top-none" id="content">
          ...
          <div id="carousel-example-generic" class="carousel slide cover overlay overflow-hidden margin-bottom-none max-height-500" data-ride="carousel">
            ...
            <?php $gallerys = App\Model\Gallery::where('property_list_id',$property->id)->get();  
        ...
        @endif
            ...
            <div class="overlay overlay-bg-black">
              <div class="v-bottom">
                <div class="page-section">
                  <h1 class="text-h1 text-overlay">{{$property->type}}</h1>
                  <p class="text-subhead text-overlay">{{$property->address}}</p>
                </div>
              </div>
              <div class="v-bottom">
          ...
          <div class="property-meta">
            <ul>
              <li class="property-meta-item"><i class="fa fa-fw icon icon-home-2"></i> {{$property->type}}</li>
              <li class="property-meta-item"><i class="fa fa-fw icon icon-bed"></i>{{$property->configuration}}</li>
          ...
          <div class="container-fluid">
            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                ...
                <?php $facility = $property->facilities;
